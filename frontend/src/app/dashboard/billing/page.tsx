...
export default function BillingPage() {
  ...
  return <div className="space-y-8">
    ...
    <Card className="border-0 ring-1 ring-hairline"><CardContent className="grid grid-cols-1 gap-6 p-6 lg:grid-cols-[1fr_1.4fr]">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2"><Usage icon={MonitorPlay} label="Screens" value={`${summary.screens_used} of ${summary.plan.max_screens}`} percent={screenPercent} /><Usage icon={HardDrive} label="Storage" value={`${bytes(summary.storage_used_bytes)} of ${bytes(summary.plan.max_storage_bytes)}`} percent={storagePercent} /></div>
    </CardContent></Card>
