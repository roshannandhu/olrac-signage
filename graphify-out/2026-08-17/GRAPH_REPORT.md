...
## Corpus Check
- 201 files · ~86,501 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1470 nodes · 3114 edges · 130 communities (99 shown, 31 thin omitted)
...
- `run()` --calls--> `Plan`  [EXTRACTED]
  tests/test_tenant_isolation.py → backend/models.py
- `run()` --calls--> `Organization`  [EXTRACTED]
  tests/test_analytics.py → backend/models.py
- `run()` --calls--> `Organization`  [EXTRACTED]
  tests/test_feature_parity.py → backend/models.py
...
Cohesion: 0.14
Nodes (20): AppRelease, Campaign, EmergencyBroadcast, EnrollmentToken, Plan, PlayLog, PlayLogHourlyRollup, Schedule (+12 more)

### Community 1 - "schemas.py"
Cohesion: 0.05
Nodes (58): Screen, Selects the most appropriate media rendition for a screen based on its hardware…, select_rendition(), create_checkout(), AppReleaseCreate, AppReleaseResponse, AppVersionResponse, BillingSummaryResponse (+50 more)
...
Cohesion: 0.10
Nodes (35): BillingPage(), percent(), exportFormats, EmergencyPage(), targetLabels, orientationLabel(), ScreenDetailPage(), AssignPlaylistCard() (+27 more)
...
Cohesion: 0.05
Nodes (76): get_redis(), datetime, Return a timezone-aware UTC timestamp., utcnow(), normalise(), Resolve the rotation a screen should apply to one playlist item. The player…, Coerce anything to one of 0/90/180/270, defaulting to 0., Degrees the player should rotate this item on this screen. (+68 more)
...
Cohesion: 0.23
Nodes (12): ensure_billing_catalog(), plan_features(), Plan, Session, get_db(), OLRAC Signage backend package. Explicit package marker. Without it `backend` is…, lifespan(), get_tenant_scope() (+4 more)

### Community 12 - "serialize_group"
Cohesion: 0.26
Nodes (12): assign_group_playlist(), create_group(), delete_group(), list_groups(), delete, get, post, put (+4 more)

### Community 13 - "auth.py"
Cohesion: 0.15
Nodes (20): ensure_initial_owner(), get_current_user(), get_current_user_ws(), get_or_create_default_organization(), get_password_hash(), login_for_access_token(), get, post (+12 more)

### Community 14 - "api.ts"
Cohesion: 0.08
Nodes (39): ALL_DAY, MODES, ScreenHoursDialog(), Windows, withDefaults(), FIT_MODES, ORIENTATIONS, ScreenSettingsDialog() (+31 more)
...
### Community 19 - "timedelta"
Cohesion: 0.12
Nodes (19): billing_summary(), list_plans(), datetime, get, Plan, post, Request, razorpay_webhook() (+11 more)
...
Cohesion: 0.17
Nodes (16): Content, MediaRendition, public_upload_url(), compute_sha256(), probe_file(), process_media(), process_media_sync(), run_command_sync() (+8 more)

### Community 22 - "dependencies"
Cohesion: 0.12
Nodes (17): @base-ui/react, class-variance-authority, dependencies, @base-ui/react, class-variance-authority, react-dom, shadcn, sonner (+9 more)
...
### Community 27 - "test_media_selection.py"
Cohesion: 0.17
Nodes (16): Organization, Playlist, PlaylistItem, User, create_user(), post, run(), setup_db() (+8 more)
...
Cohesion: 0.20
Nodes (23): QueuedUpload, GroupsPage(), ScreensPage(), StatusFilter, roleDescription, AssetCard(), AssetGrid(), OverlayBadge() (+15 more)

### Community 36 - "get_media_report"
Cohesion: 0.36
...
### Community 50 - "cn"
Cohesion: 0.13
Nodes (28): accountLinks, adminLinks, DashboardLayout(), primaryLinks, StatusIndicator(), DialogOverlay(), DropdownMenuContent(), DropdownMenuLabel() (+20 more)

### Community 51 - "test_p6_websockets.py"
Cohesion: 0.30
Nodes (12): ScreenGroup, create_access_token(), P6 realtime checks: python tests/test_p6_websockets.py Covers hierarchical…, /api/ws/dashboard/ws must reach the dashboard handler, not the device one. Both…, Push must never be the only path. The spec is explicit: if the socket is down…, _redis_available(), run(), setup_db() (+4 more)
...
Cohesion: 0.11
Nodes (24): Alert, AlertsPage(), buildAlerts(), hoursSince(), Severity, AdDetailPage(), ContentPage(), isSupported() (+16 more)
...
Cohesion: 0.18
Nodes (14): dayLabels, dayNames, DefaultTransitionPanel(), ItemRow(), PlaylistBuilder(), previewStyle(), rotationLabel(), rotationOptions (+6 more)
...
Cohesion: 0.40
Nodes (5): create_release(), list_releases(), get, post, Session

### Community 98 - "TenantScope"
Cohesion: 0.17
Nodes (12): delete, revoke_token(), delete_user(), list_users(), delete, get, put, update_user() (+4 more)
...
### Community 102 - "redacted_validation_error"
Cohesion: 0.40
...
### Community 109 - "upload_content"
Cohesion: 0.19
Nodes (14): delete_content(), generate_video_thumbnail(), get_all_content(), delete, get, post, put, UploadFile (+6 more)

### Community 110 - "useAuthStore"
Cohesion: 0.36
Nodes (6): GroupDetailPage(), LoginPage(), Home(), AuthState, useAuthStore, User
...
## Knowledge Gaps
- **258 isolated node(s):** `CheckingLocalState`, `NONE`, `FADE`, `SLIDE_LEFT`, `SLIDE_RIGHT` (+253 more)
